...
export default function Tablero() {
  ...
  const titleVisitas = (
    <>
      <List style={{ textAlign: "center" }}>
        <ListItem >
          <ListItemText primary="ULTIMOS INGRESOS REGISTRADOS" secondary="Visualiza las últimas personas que ingresaron en su establecimiento" 
  ...
  const titleGuardias = (
    <>
        <List style={{ textAlign: "center" }}>
          <ListItem>
            <ListItemText primary= "ULTIMAS MARCACIONES DE GUARDIAS" secondary="Visualiza las últimas marcaciones de los guardias"
            style={{ textAlign: "center" }}
          />
        </ListItem>
      </List>
  ...
  return (
    <>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
           ...
           <Grid item xs={6} sm={6} md={6} lg={6} xl={6} >
                            <List  style={{ paddingLeft: 190, paddingTop: 10}} >
                              <ListItem >
      ...
      <CardActionArea onClick={() => history.push("/resumen/entradas/")}>
        <CardHeader
          avatar={
            <Avatar variant="rounded" style={{ backgroundColor: "#ffffff" }}>
              <PersonIcon style={{ color: "rgb(2 81 18 / 100%)", fontSize: "40px" }} />
            </Avatar>
          }
          title={
            <Typography
              ...
              display="block"
              color="initial"
              style={{ fontSize: "12px", color: "rgb(2 81 18 / 100%)" }}
            >
              ENTRADAS
            </Typography>
          }
          subheader={
            <Typography
              variant="h4"
              display="block"
              style={{ fontSize: "14px", color: "rgb(2 81 18 / 100%)" }}
            >
              {data.ingresosDia}
            </Typography>
          }
                              ...
                              <CardHeader
                                ...
                                title={
                                  <Typography
                                    ...
                                    display="block"
                                    color="initial"
                                    style={{fontSize: "12px", color: "rgb(213 0 74 / 100%)" }}
                                  >
                                  SALIDAS
                                  </Typography>
                                }
                                subheader={
                                  <TypographyBold
                                    variant="h4"
                                    display="block"
                                    style={{fontSize: "14px", color: "rgb(213 0 74 / 100%)" }}
                                  >
                                    {data.salidasDia}
                                  </TypographyBold>
                                }
                            ...
                            >
                              <CardHeader
                                avatar={
                                  ...
                                  >
                                    <PersonIcon
                                      style={{ color: "#ff8000", fontSize: "40px" }}
                                    />
                                  </Avatar>
                                }
                                title={
                                  <Typography
                                    ...
                                    display="block"
                                    color="initial"
                                    style={{ fontSize: "12px",color: "#ff8000" }}
                                  >
                                    PERMANECENCIA
                                  </Typography>
                                }
                                subheader={
                                  <TypographyBold
                                    variant="h4"
                                    display="block"
                                    style={{fontSize: "14px", color: "#ff8000" }}
                                  >
                ...
                > 
                  <Grid>
                    <List style={{ marginLeft : 30, paddingBottom: 1, paddingTop: 5}} >
                        <ListItem >
                            <ListItemText primary="VISITAS POR DEPENDENCIAS DEL DIA" secondary="Visualiza las entradas a las dependencias del dia" />
                        </ListItem>
                    </List>
                  </Grid>
                  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <PieChart width={300} height={420}>
        <Pie
        ...
        <Legend />
           ...
           <Grid item xs={6} sm={6} md={5} lg={5} xl={5}>
          <Card>
            <CardActionArea onClick={() => history.push("/resumen/permanencia/")}>
              <Grid>
                <List style={{ marginLeft: 30, paddingBottom: 1, paddingTop: 5 }}>
                  <ListItem>
                    <ListItemText primary="PERMANENCIA POR DEPENDENCIA" secondary="Visualiza cuántas visitas aún siguen en las dependencias" />
                  </ListItem>
                </List>
              </Grid>
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
