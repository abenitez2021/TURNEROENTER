...
export default function ListaPuntos() {
  ...
  const title = (<Button
    ...
    color="primary"
    startIcon={<AddIcon />}
    onClick={() => history.push("../alta-puntoatencion")}
  ...
  return (
    <>
      {userContext.state.nombreUsu !== "" ? (
        <>
          <p>Gestion &nbsp; &nbsp;/&nbsp; &nbsp;Puntos de Atencion</p>
          <Grid container spacing={2} >
          
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              <List >
                  <ListItem >
                      <ListItemText primary="PUNTOS DE ATENCIÓN" secondary="Visualiza los Puntos de Atencion" />
                  </ListItem>
              </List>
            </Grid>
