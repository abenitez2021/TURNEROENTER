...
export default function ListasSalidasDia() {
  ...
  const handleExportPDF = () => {
    ...
    const nombreArchivo = `SALIDAS-DEL-DIA-${fechaActual}.pdf`;
  ...
  return (
    <>
      {userContext.state.nombreUsu !== "" ? (
        <>
        <p>Visitas del día &nbsp; &nbsp;/&nbsp; &nbsp;Salidas</p>
          <Grid container spacing={2} >
          
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              <List >
                  <ListItem >
                      <ListItemText primary="SALIDAS REGISTRADAS HOY" secondary="Visualiza el detalle de todos las salidas de visitantes del dia" />
                  </ListItem>
              </List>
