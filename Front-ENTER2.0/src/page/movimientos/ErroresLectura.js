                ...
                <>
                    ...
                    <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
                        ...
                        >
                            ...
                            <p><strong>Nombre:</strong> {selectedError?.nombre}</p>
                            <p><strong>Apellido:</strong> {selectedError?.apellido}</p>
                            <p><strong>Documento:</strong> {selectedError?.documento}</p>
                            <p><strong>Fecha:</strong> {selectedError?.fecha_hora}</p>
                            ...
                            <pre style={{ marginTop: 20, maxHeight: 300, overflowY: "auto", background: "#f5f5f5", padding: 10 }}>
